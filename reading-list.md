...
* Woolf, *Mrs. Dalloway* — Notice how the consciousness passes from one person to another without a seam, mid-street, mid-thought. Ask how you always knew whose mind you were in without being told. This is the origin of everything the later books do.
...
* Le Guin, *The Left Hand of Darkness* — Notice the long ice-crossing section versus the political intrigue earlier. Ask which one felt like the real book, and why the quiet stretch carries more than the plotted one.

**Pair 4**

* McCarthy, *Suttree* — Notice how little drives forward and how much simply accretes. Ask what the long unplotted passages are *for*, since they're clearly not advancing anything.
* Robinson, *Home* — Notice it's the same time and town as *Gilead* from another consciousness. Ask what changed in your understanding of events you already "knew."

**Pair 5**

* Woolf, *To the Lighthouse* — Notice the "Time Passes" middle section: a decade in an empty house, compressed into a few pages, no people. Ask what prose does with time here that no other medium could. This is principle 3 in its purest form.
...
* Le Guin, *The Dispossessed* — Notice the alternating-chapter time structure (two timelines braided). Ask what the structure itself argues that the plot doesn't.
...
* Woolf, *The Years* — Notice a single family carried across decades, each section a different year, time itself the structuring principle. Ask what accumulates across the gaps — what the years do that no continuous narrative would.
...
* Woolf, *The Waves* — Notice six voices rendered as pure soliloquy, barely characters at all. Ask whether this is the furthest the mode can go before it stops being fiction — the far edge of Woolf's own experiment.
...
* Le Guin, *The Lathe of Heaven* — Notice this is her most plot-driven (reality-altering dreams), the most genre-shaped on the list. Ask, honestly, whether it does less of the mode's work than her quieter books — a useful contrast case for what the mode *isn't*.
...
* Le Guin, *Always Coming Home* — Notice it barely behaves like a novel at all (songs, recipes, oral histories). Ask whether "constructed consciousness of a culture" is the furthest extension of the mode or a step outside it.
